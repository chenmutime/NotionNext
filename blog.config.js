...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '欢迎光临我的博客。主职Java，业余React，目标是成为独当一面的独立开发者。',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '何语晨', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个追求全栈的Java佬，但不止于编码', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.yuchentime.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '何语晨, 博客, ReactJs, NextJs', // 网站关键词 英文逗号隔开
